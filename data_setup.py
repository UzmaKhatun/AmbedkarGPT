...
# --- 2. The Document Corpus (Exact text from PDF) ---
documents = {
...
# --- 3. The Test Dataset (Exact JSON from PDF) ---
test_data = {
 "test_questions": [
 ...
 { "id": 14, "question": "What fundamental rights does Ambedkar mention in Document 3?", "ground_truth": "Right to equality, right to freedom, right against exploitation, and the right to constitutional remedies.", "source_documents": ["speech3.txt"], "question_type": "factual", "answerable": True },
...
print("✅ Data and Test Dataset Created Successfully!")